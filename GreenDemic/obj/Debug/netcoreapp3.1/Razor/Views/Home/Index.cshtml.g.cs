#pragma checksum "C:\Ngee Ann\2.2\Portfolio development\Final\GreenDemic\GreenDemic\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e611c9e221a026463cb4f8382f20d2567bce1193"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e611c9e221a026463cb4f8382f20d2567bce1193", @"/Views/Home/Index.cshtml")]
...
<div class=""contai");
            WriteLiteral(@"ner-fluid d-flex align-items-center"" style=""padding:7rem;"" id=""features"">
    <div class=""row"">
        <div class=""col-sm-4"">
            <div class=""card"" style=""border-radius: 30px; padding: 40px; box-shadow: 0px 3px 15px rgba(0,0,0,0.1);"">
                <div class=""card-body"">
                    <svg xmlns=""http://www.w3.org/2000/svg"" width=""16"" height=""16"" fill=""currentColor"" class=""bi bi-calculator"" viewBox=""0 0 16 16"">
                        ...
                        <path d=""M4 2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-2zm0 4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm3-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5");
            WriteLiteral(@" 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm3-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-4z"" />
                    </svg>
                    <h5 class=""card-title"">
        ...
        <div class=""col-sm-4"">
            ...
            WriteLiteral(@"/2000/svg"" width=""16"" height=""16"" fill=""currentColor"" class=""bi bi-cart2"" viewBox=""0 0 16 16"">
        ...
        <div class=""col-sm-4"">
            <div class=""card"" style=""border-radius: 30px; padding: 40px; box-shadow: 0px 3");
            WriteLiteral(@"px 15px rgba(0,0,0,0.1);"">
                <div class=""card-body"">
